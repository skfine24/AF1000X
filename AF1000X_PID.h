...
// EN: Power (1S LiPo)
// ============================================================================
static const float BATTERY_MIN_VOLTAGE     = 3.3f;  // KO: 컷/착륙 기준 / EN: cut/land threshold
static const float BATTERY_WARNING_VOLTAGE = 3.5f;  // KO: 경고 시작 / EN: warning threshold
...
// EN: Safety
// ============================================================================
static const float    TILT_KILL_DEG      = 45.0f;
...
static const uint32_t ARM_PULSE_MS        = 250;   // KO: 약/강/약 펄스 / EN: low/high/low
